<?php
if ( ! class_exists( 'Pearl_Dragdrop_Control' ) )
    return NULL;

/**
 * Class Pearl_Dragdrop_Control
 *
 * Custom control to display separator
 */
class Pearl_Dragdrop_Control extends WP_Customize_Control
{
    /**
    ...
    public function embed_js(){
        ...
        <script>
            ...
            function handleDragEnd( e ) {
                ...
                var optionTexts = [];
                jQuery( '.sections .section' ).each( function() { optionTexts.push( jQuery( this ).children( 'span' ).data( 'value' ) ) } );
                ...
                var esa = jQuery.Event( "keyup" );
                esa.which = 40; // # Some key code value
                db_input.trigger( esa );
            }
